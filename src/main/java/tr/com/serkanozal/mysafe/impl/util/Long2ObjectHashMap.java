...
public class Long2ObjectHashMap<V> {
    ...
    private int longHash(final long value, final int mask) {
    ...
    public boolean containsKey(final Object key) {
        assert key != null : "Null keys are not permitted";
    ...
    public V computeIfAbsent(final long key, final LongFunction<? extends V> mappingFunction) {
        assert mappingFunction != null : "mappingFunction cannot be null";
        V value = get(key);
        if (value == null) {
    ...
    private class EntrySet<V> extends AbstractSet<Map.Entry<Long, V>> {
        ...
        @Override
        public Spliterator<java.util.Map.Entry<Long, V>> spliterator() {
            throw new UnsupportedOperationException();
        }

        @Override
        public boolean removeIf(Predicate<? super java.util.Map.Entry<Long, V>> filter) {
            throw new UnsupportedOperationException();
        }

        @Override
        public Stream<java.util.Map.Entry<Long, V>> stream() {
            throw new UnsupportedOperationException();
        }

        @Override
        public Stream<java.util.Map.Entry<Long, V>> parallelStream() {
            throw new UnsupportedOperationException();
        }

        @Override
        public void forEach(Consumer<? super java.util.Map.Entry<Long, V>> action) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    public class EntryIterator<V>
        ...
        public void forEachRemaining(
                Consumer<? super java.util.Map.Entry<Long, V>> action) {
            throw new UnsupportedOperationException();
        }
    }
